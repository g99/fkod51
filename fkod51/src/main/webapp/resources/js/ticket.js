var Ticket = {
				...
				main : function() {
					...
					var main = '<div class="container"><div class="row"><div class="col-lg-12 text-center"><h2 class="margin-top-0 text-primary">예매하기</h2></div></div></div><div class="container"><div class="row"><div class="col-lg-2 col-md-8 text-center"><div class="feature"><h3>영화</h3><hr class="primary"><ul class="nav nav-tabs"><li class="active"><a data-toggle="tab" href="#tab1" style="padding: 5px;">예매율</a></li><li><a data-toggle="tab" href="#tab2" style="padding: 5px;">가나다</a></li></ul><div class="tab-content"><div id="tab1" class="tab-pane fade in active ticket_sub"><h3>예매율순</h3></div><div id="tab2" class="tab-pane fade ticket_sub"><h3>가나다순</h3></div></div></div></div><div class="col-lg-3 col-md-8 text-center"><div class="feature"><h3>극장</h3><hr class="primary"><div id="theater_list"></div></div></div><div class="col-lg-3 col-md-8 text-center"><div class="feature"><h3>날짜</h3><hr class="primary"><div id="date_list"></div></div></div><div class="col-lg-3 col-md-8 text-center"><div class="feature"><h3>시간</h3><hr class="primary"><div id="times_list"></div></div></div></div></div><div class="container"><div class="row"><div class="col-lg-11 text-right"><input id="choiceseat" type="button" value="좌석선택" style="display: none;"><label for="choiceseat" class="button" style="font-size: 20px;">좌석선택</label></div></div></div>';
